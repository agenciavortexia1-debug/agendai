...
export default function Dashboard({ session }: { session: Session }) {
  ...
  const [notificationsViewed, setNotificationsViewed] = useState(() => {
    return localStorage.getItem('notifications_viewed_at') === format(new Date(), 'yyyy-MM-dd');
  });
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto pb-24 md:pb-10 bg-zinc-50/50">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 md:mb-10">
          ...
          <div className="w-full md:w-auto">
            <a
              href="/staff/login"
              className="flex items-center justify-center gap-2 bg-zinc-900 text-white px-6 py-3 rounded-xl font-sans font-semibold hover:bg-black transition-all shadow-sm w-full md:w-auto"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl border border-zinc-200 shadow-sm relative overflow-hidden group">
                <div className="flex items-center justify-between mb-4">
                  ...
                  {recentActivity.length > 0 && !notificationsViewed && (
              ...
              <div className="flex items-center gap-3 mb-6">
                <button
                  onClick={() => {
                    ...
                    localStorage.setItem('notifications_viewed_at', format(new Date(), 'yyyy-MM-dd'));
                  }}
